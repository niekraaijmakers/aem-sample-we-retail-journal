...
const clientLibRoot = resolveApp('../ui.apps/jcr_root' + clientLibPath);
...
module.exports = {
    ...
    serviceWorkerSrcAbsolutePath: resolveApp('src/service-worker.js'),
    serviceWorkerDestAbsolutePath: clientLibRoot + '/service-worker.js',
