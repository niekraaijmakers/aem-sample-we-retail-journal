...
public class SpaPageBindingsProviderImpl implements SpaPageBindingsProvider, Filter {
    ...
    static final Pattern SPA_PATH_CHECK = Pattern.compile("/content/we-retail-journal(.*)\\.html");
    
    private static final String HEADER_REQUESTED_BY = "requested-by";
    private static final String RT_SPA_CONTENT_PAGE = "we-retail-journal/spa/components/structure/page";
    private static final String RT_SPA_XF_PAGE = "we-retail-journal/spa/components/structure/xf-page";
