...
const clientLibPath = '/apps/we-retail-journal/clientlibs/clientlib-site-angular/resources';
...
module.exports = {
    ...
    publicPath: '/etc.clientlibs/we-retail-journal/clientlibs/clientlib-site-angular/resources/',
